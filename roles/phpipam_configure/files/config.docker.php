...
// Behind BunkerWeb: TLS is terminated upstream and the backend listens on 80.
// phpIPAM builds absolute URLs from these two values, so fix them here rather
// than fighting Apache, which ignores SetEnvIf for SERVER_PORT.
